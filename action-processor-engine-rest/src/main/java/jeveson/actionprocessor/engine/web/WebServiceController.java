...
@Controller
@RequestMapping ("/json")
public class WebServiceController extends AbstractActionProcessor implements BeanFactory,Constants {
	
	@Autowired
	private ApplicationContext applicationContext;
	
	@RequestMapping(method = RequestMethod.POST,headers="Accept=*/*", produces = "application/json", consumes="application/json")
	public @ResponseBody HashMap<String, Object> getPathProcessAction(@RequestBody Map<String, String> requestParams) {
	...
	@RequestMapping(value = "/{name}", method = RequestMethod.POST,headers="Accept=*/*", produces = "application/json", consumes="application/json")
	public @ResponseBody HashMap<String, Object> getProcessAction(@PathVariable String name, @RequestBody Map<String, String> requestParams) {
